  ...
  try {
    ...
    if (title) {
      ...
      if (alreadyExists) {
        ...
        throw new Error("Ya existe un contenido teórico con este título o contenido.");
    ...
    res.status(400).json(`Algo salió mal en el controller POST_THEORIC: ${err.message}`);
  }
};
